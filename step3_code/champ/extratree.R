...
c<-read.csv("~/TCGA/Methylation450K/Three_method/feature/Extratree.csv")
c<-c[1:50,2]    
...
write.csv(b,paste0(file="~/TCGA/Methylation450K/Three_method/data/Extratree.csv"),quote=F,row.names=F)