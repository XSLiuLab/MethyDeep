...
for i in [50]:
    for m in [10]:
        ...
        f = open("/public/slst/home/ningwei/TCGA/Methylation450K/feature_importance_6_15/best_param/"+"new_RF_"+str(i)+"_"+str(m)+"txt",'a') #若文件不存在，系统自动创建。'a'表示可连续写入到文件，保留原内容，在原内容之后写入。可修改该模式（'w+','w','wb'等）
