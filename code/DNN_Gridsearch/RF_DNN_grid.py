...
f = open("/public/slst/home/ningwei/methylation/process_data/DNN_train_data/"+"RF"+str(m)+"_11_23.txt",'a') #若文件不存在，系统自动创建。'a'表示可连续写入到文件，保留原内容，在原内容之后写入。可修改该模式（'w+','w','wb'等）
