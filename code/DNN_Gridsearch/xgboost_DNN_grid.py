...
if m ==5 :
    ...
    param_grid = dict(n_layers=[3,4,5,6], first_layer_nodes = [50,40], last_layer_nodes = [40], dropout=[0,0.1], activation_func = activation_funcs, loss_func = loss_funcs, batch_size = [100,80], epochs = [50,100])
if m ==10 :
    #param_grid = dict(n_layers=[2,3,4,5,6,7], first_layer_nodes = [10000,8000,6000,5000,4000], last_layer_nodes = [60,90,120], dropout=[0,0.1,0.3,0.5,0.7,0.9], activation_func = activation_funcs, loss_func = loss_funcs, batch_size = [100,50], epochs = [50])
    param_grid = dict(n_layers=[3,4,5,6], first_layer_nodes = [100,80,60], last_layer_nodes = [50,40], dropout=[0,0.3], activation_func = activation_funcs, loss_func = loss_funcs, batch_size = [100,80], epochs = [50,100])
if m == 15 :
    #param_grid = dict(n_layers=[2,3,4,5,6,7], first_layer_nodes = [10000,8000,6000,5000,4000], last_layer_nodes = [60,90,120], dropout=[0,0.1,0.3,0.5,0.7,0.9], activation_func = activation_funcs, loss_func = loss_funcs, batch_size = [100,50], epochs = [50])
    param_grid = dict(n_layers=[3,4,5,6], first_layer_nodes = [150,130,110,90], last_layer_nodes = [50,40], dropout=[0,0.3,0.5], activation_func = activation_funcs, loss_func = loss_funcs, batch_size = [100,80], epochs = [50,100])
if m == 20 :
    #param_grid = dict(n_layers=[2,3,4,5,6,7], first_layer_nodes = [10000,8000,6000,5000,4000], last_layer_nodes = [60,90,120], dropout=[0,0.1,0.3,0.5,0.7,0.9], activation_func = activation_funcs, loss_func = loss_funcs, batch_size = [100,50], epochs = [50])
    param_grid = dict(n_layers=[3,4,5,6], first_layer_nodes = [200,180,160,140], last_layer_nodes = [50,40], dropout=[0,0.3,0.5], activation_func = activation_funcs, loss_func = loss_funcs, batch_size = [100,80], epochs = [50,100])
if m == 25 :
    #param_grid = dict(n_layers=[2,3,4,5,6,7], first_layer_nodes = [10000,8000,6000,5000,4000], last_layer_nodes = [60,90,120], dropout=[0,0.1,0.3,0.5,0.7,0.9], activation_func = activation_funcs, loss_func = loss_funcs, batch_size = [100,50], epochs = [50])
    param_grid = dict(n_layers=[3,4,5,6], first_layer_nodes = [250,230,200,180,160,130], last_layer_nodes = [50,40], dropout=[0,0.3,0.5], activation_func = activation_funcs, loss_func = loss_funcs, batch_size = [100,80], epochs = [50,100])
if m == 30 :
    #param_grid = dict(n_layers=[2,3,4,5,6,7], first_layer_nodes = [10000,8000,6000,5000,4000], last_layer_nodes = [60,90,120], dropout=[0,0.1,0.3,0.5,0.7,0.9], activation_func = activation_funcs, loss_func = loss_funcs, batch_size = [100,50], epochs = [50])
    param_grid = dict(n_layers=[3,4,5,6], first_layer_nodes = [300,280,250,230,200,180,150], last_layer_nodes = [50,40], dropout=[0,0.3,0.5], activation_func = activation_funcs, loss_func = loss_funcs, batch_size = [100,80], epochs = [50,100])
if m == 35 :
    #param_grid = dict(n_layers=[2,3,4,5,6,7], first_layer_nodes = [10000,8000,6000,5000,4000], last_layer_nodes = [60,90,120], dropout=[0,0.1,0.3,0.5,0.7,0.9], activation_func = activation_funcs, loss_func = loss_funcs, batch_size = [100,50], epochs = [50])
    param_grid = dict(n_layers=[3,4,5,6], first_layer_nodes = [350,330,310,280,250,230,200,180], last_layer_nodes = [50,40], dropout=[0,0.3,0.5], activation_func = activation_funcs, loss_func = loss_funcs, batch_size = [100,80], epochs = [50,100])
if m == 40 :
    #param_grid = dict(n_layers=[2,3,4,5,6,7], first_layer_nodes = [10000,8000,6000,5000,4000], last_layer_nodes = [60,90,120], dropout=[0,0.1,0.3,0.5,0.7,0.9], activation_func = activation_funcs, loss_func = loss_funcs, batch_size = [100,50], epochs = [50])
    param_grid = dict(n_layers=[3,4,5,6], first_layer_nodes = [400,380,360,340,310,280,250,230,200], last_layer_nodes = [50,40], dropout=[0,0.3,0.5], activation_func = activation_funcs, loss_func = loss_funcs, batch_size = [100,80], epochs = [50,100])
if m == 45 :
    #param_grid = dict(n_layers=[2,3,4,5,6,7], first_layer_nodes = [10000,8000,6000,5000,4000], last_layer_nodes = [60,90,120], dropout=[0,0.1,0.3,0.5,0.7,0.9], activation_func = activation_funcs, loss_func = loss_funcs, batch_size = [100,50], epochs = [50])
    param_grid = dict(n_layers=[3,4,5,6], first_layer_nodes = [450,430,410,400,380,360,340,310,280,250], last_layer_nodes = [50,40], dropout=[0,0.3,0.5], activation_func = activation_funcs, loss_func = loss_funcs, batch_size = [100,80], epochs = [50,100])
if m == 50 :
    #param_grid = dict(n_layers=[2,3,4,5,6,7], first_layer_nodes = [10000,8000,6000,5000,4000], last_layer_nodes = [60,90,120], dropout=[0,0.1,0.3,0.5,0.7,0.9], activation_func = activation_funcs, loss_func = loss_funcs, batch_size = [100,50], epochs = [50])
    param_grid = dict(n_layers=[3,4,5,6], first_layer_nodes = [500,470,450,430,410,400,380,360,340,310,280,250], last_layer_nodes = [50,40], dropout=[0,0.3,0.5], activation_func = activation_funcs, loss_func = loss_funcs, batch_size = [100,80], epochs = [50,100])
...
f = open("/public/slst/home/ningwei/methylation/process_data/DNN_train_data/"+"Xgboost"+str(m)+"_11_23.txt",'a') #若文件不存在，系统自动创建。'a'表示可连续写入到文件，保留原内容，在原内容之后写入。可修改该模式（'w+','w','wb'等）
